...
connectionRoutes.route('/updateConnectionWithPatient/:id').post(function (req, res, next) {
  Connection.findOneAndUpdate({_id: req.params.id},{$set:{patient: req.body.patient}},
    (err, connection)=> {
