...
export class PatientAddComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private as: AppService,
    ...
    createForm() {
      ...
      addPatient(pname:any, password: any, date_of_birth:string, taj_number:any, medical_history:any, gender:any) {
        ...
        if(sthingContainedInTheDB == false) {
          ...
          this.as.addPatient(pname, password, Date.parse(date_of_birth), taj_number, medical_history, gender);
